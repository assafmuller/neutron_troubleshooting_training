...
neutron router-gateway-clear exercise_03

neutron router-interface-delete exercise_03 exercise_03
neutron router-delete exercise_03
subnet_id=`neutron subnet-show -F id --format=value exercise_03`
...
neutron net-delete exercise_03
